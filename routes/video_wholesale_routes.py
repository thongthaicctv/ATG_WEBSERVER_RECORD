# routes/video_wholesale_routes.py
# -*- coding: utf-8 -*-
...
video_wholesale_bp = Blueprint("video_wholesale", __name__)


@video_wholesale_bp.route("/")
def index():
    ...
    if box_code:
        sql += " AND box_code LIKE %s"
        params.append(f"%{box_code}%")
